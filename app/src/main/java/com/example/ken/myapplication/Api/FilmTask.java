...
public class FilmTask extends AsyncTask<String, Void, String> {
    ...
    public static class filmQueries {
        ...
        public static final String popularUrl = "https://api.themoviedb.org/3/movie/popular?api_key=1acf462bb1b2209ec45597c87045bcf8&language=en&page=1";

    }
}
// https://api.themoviedb.org/3/movie/popular?api_key= ac&language=nl&page=1
// API KEY 1acf462bb1b2209ec45597c87045bcf8
